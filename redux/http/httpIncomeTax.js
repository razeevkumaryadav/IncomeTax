...
import {incomeTax,currentDate,getMakePayment } from './_config'

console.log("test api");
// debugger;100001826
var token ='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VySWQiOiIxLjAiLCJVc2VyTmFtZSI6ImthYmlyIiwibmJmIjoxNjU1NDU4NTExLCJleHAiOjE2NTU0NTk0MTEsImlhdCI6MTY1NTQ1ODUxMX0.2UdtxBlm2zlE7sH0EsuBM5srFiDlYwtDy4YRJVCU4eY';
const headerParams = {
...
export const httpGetCurrentDate = ()=>axios.get(incomeTax+`/Date/GetCurrentDateNep`);
...
export const httpGetMakePayment = ()=>axios.get(getMakePayment);